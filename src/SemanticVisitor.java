            ...
            if(dot.getChildren().get(0).getKind().equals("Length")) {
                ...
                if(!symbolTable.getMethods().contains(methodCallName) && !importMethod && !superMethod) {
                    ...
                    for(int i = 0; i < methodArgs.size(); i++) {
                        ...
                        if(!argType.equals(methodNode.getChildren().get(i+1).getKind()) && !argType.equals(identifierType) && !((methodNode.getChildren().get(i+1).getKind().equals("AdditiveExpression")) && argType.equals("int")) && !((methodNode.getChildren().get(i+1).getKind().equals("SubtractiveExpression")) && argType.equals("int")) && !((methodNode.getChildren().get(i+1).getKind().equals("MultiplicativeExpression")) && argType.equals("int")) && !((methodNode.getChildren().get(i+1).getKind().equals("DivisionExpression")) && argType.equals("int")) && !((methodNode.getChildren().get(i+1).getKind().equals("Less")) && argType.equals("boolean")) && !((methodNode.getChildren().get(i+1).getKind().equals("And")) && argType.equals("boolean")) && !((methodNode.getChildren().get(i+1).getKind().equals("Not")) && argType.equals("boolean")) && !(methodNode.getChildren().get(i+1).getKind().equals("TwoPartExpression") && (argType.equals(getTwoPartExpressionType(methodNode.getChildren().get(i+1))) || getTwoPartExpressionType(methodNode.getChildren().get(i+1)).equals(" ")))) {
